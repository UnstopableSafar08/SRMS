...
<body>
    ...
    <div class="container">
        ...
        <div class="result">
            <?php echo '<p>Total Marks: 500'.'</p>';  ?>
            <?php echo '<p>Total Obt. Marks:&nbsp'.$mark.'</p>';?>
        ...
        <div class="button">
           <br>
           <a class="btn btn-info btn-xs" href="login.php" role="button"> HOME <i class="fas fa-home fa-lg"></i></a>
           <button type="button" class="btn btn-primary" onclick="window.print()"><b>Print Result</b> <i class="fas fa-print fa-lg"></i></button>
        </div>
    </div>
</body>
</html>